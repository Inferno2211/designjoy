              ...
              <div className="marquee overflow-hidden">
                <div className="marquee-inner flex whitespace-nowrap animate-scroll-left w-[200%]">
                  {[1, 2].map((_, index) => (
                    <div
                      key={index}
                      className="marquee-element w-[1/2] flex-shrink-0"
                    >
                      {[1, 2, 3, 4, 5, 6].map((num) => (
                        <Image
                          key={num}
                          sizes="(max-width: 726px) 100vw, 726px"
                          src={`/image/pricingdetail${num}.png`}
                          alt=""
                          width={726}
                          height={150}
                          loading="lazy"
              ...
              >
                <div>
                  <div className="div-block-33">
                    {[
                      {
                        icon: "/image/coffeecup.svg",
                        title: "Buy Me A Coffee",
                        subtitle: "Fintech Product of the Year",
                      },
                      {
                        icon: "/image/switchboard.svg",
                        title: "Switchboard",
