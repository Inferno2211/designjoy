        ...
        <div style={{ opacity: 0 }} className="inner-container">
          <div className="footer__flex">
            <div className="footer__left">
              ...
              <a
                href="#pricing"
                className="button-filled m-t-16 w-inline-block"
              >
                <div>See pricing</div>
              </a>
            </div>
            <div className="footer__right">
              ...
              <div className="footer__links-flex">
                ...
                <a
                  href="https://www.figma.com/@brettfromdj"
                  target="_blank"
                  className="footer__link"
                >
                  Figma
                ...
                <a
                  href="https://www.linkedin.com/in/brettfromdj/"
                  target="_blank"
                  className="footer__link"
                >
                  LinkedIn
                ...
                <a
                  href="mailto:hello@designjoy.co?subject=Hello!"
                  className="footer__link"
                >
                  Email
                </a>
          ...
          <div className="footer__bottom">
            ...
            <div className="footer__legal-text">
              Copyright © 2024 Designjoy LLC. All rights reserved.
            </div>
          </div>
        </div>
