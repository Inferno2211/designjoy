        ...
        <div className="services__row">
          <div className="services__col">
            <div className="services__block _1">
              <Image style={{ transform: 'translate3d(0, 130px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)' }} src="/Trello-Logo--Streamline-Logos.png" alt="" width={60} height={60} loading="lazy" className="image-8" />
            </div>
          ...
          <div className="services__col">
            <div className="services__block _3">
              <Image loading="lazy" src="/Lock-Square-Dial-Pad--Streamline-Nova.png" alt="" width={50} height={50} className="image-8 _4" />
            </div>
          ...
          <div className="services__col">
            <div className="services__block _2">
              <Image loading="lazy" src="/Flash-Enable-Allow-1--Streamline-Nova.png" alt="" width={60} height={60} className="image-8 _3" />
            </div>
          ...
          <div className="services__col">
            <div className="services__block _4">
              <Image loading="lazy" src="/Star--Streamline-Nova.png" alt="" width={70} height={70} className="image-8 _2" />
            </div>
          ...
          <div className="services__col">
            <div className="services__block _5">
              <Image style={{ transform: 'translate3d(0, 130px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)' }} loading="lazy" alt="" src="/Resize-Expand--Streamline-Nova.png" width={60} height={60} className="image-8" />
            </div>
          ...
          <div className="services__col last">
            <div className="services__block _6">
              <Image style={{ transform: 'translate3d(0, 130px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)' }} loading="lazy" alt="" src="/Touch-Id--Streamline-Nova.png" width={60} height={60} className="image-8" />
            </div>
